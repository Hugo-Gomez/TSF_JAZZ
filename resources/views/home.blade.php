...
@section('content')
<div class="container" style="background-image: url('../public/img/jazz1.jpg');">
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="container-fluid">
                        <h1 class="well" style="background-color:#008B8B; color:#E0FFFF;">Page Administrateur</h1>
                        <div class="row">
                            <a href="{{ url('home') }}" ><div class="col-sm-4  col-lg-4 panel well-lg" style="background-color:lavender;"> NEWS </div></a>
                            <a href="{{ url('blog/admin') }}" ><div class="col-sm-4 col-lg-4 panel well-lg" style="background-color:lavenderblush;"> BLOG </div></a>
                            <a href="{{ url('newsletter/admin') }}" ><div class="col-sm-4  col-lg-4 panel well-lg" style="background-color:lavender;"> NEWSLETTER </div></a>
                        </div>
